                ...
                timer: setInterval(function() {
                    ...
                    if((secUntilMidnight() >= 0 && secUntilMidnight() <= 6 && require("../bot.js").raffle.canRoll) || require("../bot.js").raffle.mustRoll){ // lottery roll !
                        if(require("../bot.js").raffle.tickets.length > 20){
                            ...
                            require("../bot.js").dexonbot.webClient.doSay("[Raffle] @"+winner+" just won the Raffle! | Won amount: "+require("../bot.js").raffle.pot()+" Bits", 'english');
                            ...
                            require("../bot.js").raffle.canRoll = false;
                            require("../bot.js").dexonbot.webClient.doSay("[Raffle] Not enough tickets bought. No winner today. See you tomorrow!", 'english');
                        }
                    }
